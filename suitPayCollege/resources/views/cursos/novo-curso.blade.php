                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="vagas" name="vagas" placeholder="Nº Vagas">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="descricaoCurso">Descrição do curso</label>
                        <textarea class="form-control" rows="6" id=descricaoCurso" name="descricaoCurso" placeholder="Descrição do curso"></textarea>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="prazoInscricao" name="prazoInscricao" >
                            </div>
                        </div>
                    </div>
